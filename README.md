...
<img src='https://github.com/improgo-josh/Twitter_App_Clone/blob/master/Twitter_Assignment_2_Part_2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
# Project 2 - Tweet Clone

**Tweet Clone** is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
